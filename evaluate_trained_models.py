...
if __name__ == "__main__":
    ...
    df_train, df_test = evaluate_explanations(train_data, test_data, methods, save_results = True, convert_to_imagenet_labels=False, save_title="polarised_SSIM_results")
    print('run complete')
